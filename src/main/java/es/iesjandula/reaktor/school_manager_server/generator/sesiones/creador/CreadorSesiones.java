...
public class CreadorSesiones
{
    ...
    public void crearSesion(Asignatura asignatura, Profesor profesor, boolean tipoHorarioMatutino, RestriccionHoraria restriccionHoraria)
    {
        ...
        listaSesionesElegida.add(new SesionAsignatura(asignatura, profesor, tipoHorarioMatutino, restriccionHoraria)) ;
    }
     ...
     * @param restriccionHoraria restricción horaria
     */
    public void crearSesion(Reduccion reduccion, Profesor profesor, boolean tipoHorarioMatutino, RestriccionHoraria restriccionHoraria)
    {
        // Por defecto, la lista de sesiones elegida es la de sin restricciones
        List<SesionBase> listaSesionesElegida = this.sesionesSinRestricciones ;
        ...
        // Añadimos la sesión a la lista elegida
        listaSesionesElegida.add(new SesionReduccion(reduccion, profesor, tipoHorarioMatutino, restriccionHoraria)) ;
    }
