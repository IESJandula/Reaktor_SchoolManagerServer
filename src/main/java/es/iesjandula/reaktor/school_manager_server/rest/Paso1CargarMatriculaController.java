...
public class Paso1CargarMatriculaController
{
    ...
    public ResponseEntity<?> cargarMatriculas()
    {
        try
        {
            ...
            {
                String mensajeError = "No se ha encontrado matriculas en base de datos";
                                              ...
                                              @RequestHeader(value = "etapa", required = true) String etapa)
    {
        try
        {
            ...
            {
                String mensajeError = "No se ha encontrado matriculas para borrar para ese curso y etapa";
