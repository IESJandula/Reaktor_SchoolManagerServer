...
{
  @Query("SELECT oa FROM ObservacionesAdicionales oa WHERE oa.profesor.cursoAcademico = :cursoAcademico AND oa.profesor.email = :email")
  Optional<ObservacionesAdicionales> buscarPorEmail(@Param("cursoAcademico") String cursoAcademico, @Param("email") String email) ;
}
