...
/**
 * Clase que representa la clave primaria compuesta para la entidad GeneradorAsignadaImpartir (o la entidad que la use).
 * -----------------------------------------------------------------------------------------------------------------
...
@NoArgsConstructor
@EqualsAndHashCode
public class IdGeneradorAsignadaImpartir implements Serializable
{
