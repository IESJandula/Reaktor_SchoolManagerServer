...
/**
 * Clase que representa la clave primaria compuesta para la entidad GeneradorRestriccionesImpartir.
 * -----------------------------------------------------------------------------------------------------------------
 * Esta clave primaria está compuesta por las claves primarias de las entidades
 * GeneradorInstancia ({@link Integer}), Impartir ({@link Impartir}) y
